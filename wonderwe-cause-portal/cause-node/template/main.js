...
require([
    ...
    Handlebars.registerHelper('apitype', function(options) {
    console.log(options.fn(this));
    var returnValue='<span class="badge alert-success"><i class="fa fa-plus"></i></span>';
    if(options.fn(this)==='get'){
      returnValue='<span class="badge alert-info"><i class="fa fa-arrow-down"></i></span>';
    }else if(options.fn(this)==='post'){
      returnValue='<span class="badge alert-success"><i class="fa fa-plus"></i></span>';
    }else if(options.fn(this)==='put'){
      returnValue='<span class="badge alert-warning"><i class="fa fa-pencil></i></span>';
    }else if(options.fn(this)==='delete'){
      returnValue='<span class="badge alert-danger"><i class="fa fa-times"></i></span>';
    }
    return returnValue;
  });
